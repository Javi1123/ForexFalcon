...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Gestiona y administra todos los recibos de pago de Certitransporte. Controla estados, fechas de pago, cantidades y realiza operaciones de edición o eliminación de recibos.">
    <meta name="keywords" content="Certitransporte, recibos, pagos, gestión de recibos, facturación, estados de pago, panel admin, cobros, administración de pagos">
    ...
    <script src="<?= LINKS_PATH . "/js/code_js_jquerys/accionesTablaRecibos.js" ?>" defer></script>
      ...
      <main class="app-main">
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">Tabla de recibos</h3>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="<?= BASE_PATH . "/admin" ?>">Inicio</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Tabla de recibos</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="card mb-4">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <button type="button" id="btnGenerarRecibos" class="btn btn-tool btn-sm" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-custom-class="crear-tooltip" data-bs-html="true" aria-label="&lt;b&gt;Generar recibos &lt;/b&gt;" data-bs-original-title="&lt;b&gt;Generar recibos&lt;/b&gt;">
                      <i class="bi bi-plus-circle-fill green"></i>
                    </button>
                </div>
                </div>
                <div class="table-responsive">
                  <table id="tablaRecibos" class="table table-striped align-middle responisve">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>DNI</th>
                    ...
                    <tbody>
                      <?php foreach($recibos as $rec) : ?>
                        <tr data-id="<?= $rec["ID"] ?>">
                          ...
                          <td class="DNI"><?= $rec["DNI"] ?></td>
                          <td class="claveCurso text-center"><?= $rec["claveCurso"] ?></td>
                          <td class="nombre"><?= $rec["nombre"] ?></td>
                          <td class="apellido"><?= $rec["apellido"] ?></td>
                          <td class="fechaPago"><?= $rec["fechaPago"] ?></td>
                          <td class="estado"><?= $rec["estado"] ?></td>
                          <td class="cantidad"><?= $rec["cantidad"] ?></td>
                          <td class="text-center">
                            <button type="button" id="<?= $rec["ID"] ?>" class="btn btn-tool btnEditarCurso" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="editar-tooltip" data-bs-html="true" title="<b>Editar recibo</b>"><i id="<?= $rec["ID"] ?>" class="bi bi-pen-fill orange"></i></button>
                            <button type="button" id="<?= $rec["ID"] ?>" class="btn btn-tool btnDarAlta" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="baja-tooltip" data-bs-html="true" title="<b>Borrar recibo</b>"><i id="<?= $rec["ID"] ?>" class="bi bi-trash-fill red"></i></button>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
